...
class HistoryPageFragment: Fragment(), HistoryPageContract.View {
    ...
    private var data : MutableList<HistoryResponse> = listOf(
        HistoryResponse(
            "",
            "Rezi Lobzhanidze1",
            "On my way home, but i needed to bring some things, so i stayed at home and I did not have enough time",
            Date(123422421)
        ),
        HistoryResponse(
            "",
