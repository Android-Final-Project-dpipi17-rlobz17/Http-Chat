...
class ChatPageRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private var cells : List<MessageCellModel> = listOf(
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", false),
        MessageCellModel("bbbbbbbbbbbbbbbbbbbbbb", true),
        MessageCellModel("cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc", true),
        MessageCellModel("ggggggggggggggggggggggggggggggggggggggggggggggggggg", true),
        MessageCellModel("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", false),
        MessageCellModel("vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv", true),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", false),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", true),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", true),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", false),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", false),
        MessageCellModel("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", true),
